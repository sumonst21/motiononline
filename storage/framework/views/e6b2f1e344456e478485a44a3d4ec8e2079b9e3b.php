...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-color:#999999; padding:0px; margin:0px;">	
		...
		<ul id="trailer">
			...
			?>
			<li data-thumb-source="<?php echo e(asset('images/movies/thumbnails/'.$movie->thumbnail)); ?>" data-video-source="<?php echo e($url); ?>" data-poster-source="<?php echo e(asset('images/movies/posters/'.$movie->poster)); ?>"> 
