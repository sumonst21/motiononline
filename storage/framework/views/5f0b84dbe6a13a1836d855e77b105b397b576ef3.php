    ...
    <div class="row">
      <div class="col-md-6">
        <div class="admin-form-block z-depth-1">
          <?php echo Form::model($package, ['method' => 'PATCH', 'action' => ['PackageController@update', $package->id], 'files' => true]); ?>
            ...
            <div class="form-group<?php echo e($errors->has('amount') ? ' has-error' : ''); ?>">
               ...
               <div class="form-group<?php echo e($errors->has('mycolor') ? ' has-error' : ''); ?>">
                        <?php echo Form::label('mycolor', 'Plan Colors'); ?>

                        <p class="inline info"> - Please select Color for This Plan</p>
                       
                        <?php echo Form::select('mycolor', ['gold'=>'Gold', 'platinum' => 'Platinum', 'black' => 'Black'],
                         ['gold'=>'Gold'], ['class' => 'form-control select2', 'required' => 'required']); ?>

                        
                        <small class="text-danger"><?php echo e($errors->first('mycolor')); ?></small>
                     </div>
