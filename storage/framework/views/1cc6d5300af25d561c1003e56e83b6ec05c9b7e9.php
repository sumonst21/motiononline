                  ...
                  <div class="pad_plus_border">
                    <div class="bootstrap-checkbox slide-option-switch form-group<?php echo e($errors->has('select_urls') ? ' has-error' : ''); ?>">
                      <div class="row">
                        ...
                        <div class="col-md-5 pad-0">
                          <div class="make-switch">
                            <?php echo Form::checkbox('ready_url_check', 1, ($episode->video_link->ready_url != null ? 1 : 0), ['class' => 'bootswitch TheCheckBox', 'id' => 'TheCheckBox', "data-on-text"=>"Ready Urls", "data-off-text"=>"Custom Url", "data-size"=>"small"]); ?>
                    ...
                    <div id="ready_url" class="form-group<?php echo e($errors->has('ready_url') ? ' has-error' : ''); ?> ready_url">
                        <?php echo Form::label('ready_url', 'Youtube or Viemo Video Url'); ?>
