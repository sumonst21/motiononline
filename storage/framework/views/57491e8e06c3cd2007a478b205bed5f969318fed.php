            ...
            <div class="form-group">
             ...
             <div class="form-group">
              <label class="bootstrap-switch-label">
                <input <?php echo e($movie->video_link->iframeurl != null ? "checked" : ""); ?> id="iframecheck" type="checkbox" name="iframecheck" data-on-text="IFRAME URL" data-off-text="URLs" data-size="small" class='bootswitch'>
              </label>
            </div>

            <div style="display: <?php echo e($movie->video_link->iframeurl != null ? "" : "none"); ?>" id="ifbox" class="form-group">
              <label for="iframeurl">IFRAME URL: </label> <a data-toggle="modal" data-target="#embdedexamp"><i class="fa fa-question-circle-o"> </i></a>
              <input value="<?php echo e($movie->video_link->iframeurl); ?>" type="text" class="form-control" name="iframeurl">
            </div>
          ...
          <div  class="modal fade" id="embdedexamp" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
              <div class="modal-content">
                ...
                <div class="modal-body">
                  ...
                  <p style="font-size: 15px;"><b>Openload:</b> https://openload.co/embed/videoID </p>
						...
						<div style="display: <?php echo e($movie->video_link->iframeurl != null ? "none;" : ""); ?>" id="urlbox" class="pad_plus_border">
              ...
              <div id="ready_url" class="form-group<?php echo e($errors->has('ready_url') ? ' has-error' : ''); ?>">
                  ...
                  <?php echo Form::text('ready_url', $movie->video_link->ready_url, ['class' => 'form-control', 'placeholder' => 'Please enter your video url']); ?>
              ...
              <div id="custom_url">
                <div class="form-group<?php echo e($errors->has('url_360') ? ' has-error' : ''); ?>">
                    ...
                    <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter your video url"></i>
                    <?php echo Form::text('url_360', $movie->video_link->url_360, ['class' => 'form-control', 'placeholder' => 'Please enter your video url']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('url_480') ? ' has-error' : ''); ?>">
                    ...
                    <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter your video url"></i>
                    <?php echo Form::text('url_480', $movie->video_link->url_480, ['class' => 'form-control', 'placeholder' => 'Please enter your video url']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('url_720') ? ' has-error' : ''); ?>">
                    ...
                    <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter your video url"></i>
                    <?php echo Form::text('url_720', $movie->video_link->url_720, ['class' => 'form-control', 'placeholder' => 'Please enter your video url']); ?>
                ...
                <div class="form-group<?php echo e($errors->has('url_1080') ? ' has-error' : ''); ?>">
                    ...
                    <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="Please enter your video url"></i>
                    <?php echo Form::text('url_1080', $movie->video_link->url_1080, ['class' => 'form-control', 'placeholder' => 'Please enter your video url']); ?>
