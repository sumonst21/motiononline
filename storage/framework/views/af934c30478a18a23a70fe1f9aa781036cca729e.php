...
<ul id="playlist2" style="display:none;">
   ...
   <li  data-thumb-source="<?php echo e(asset('images/tvseries/thumbnails/'.$episode->seasons->thumbnail)); ?>" data-video-source="<?php echo e($slink->ready_url); ?>" data-poster-source="<?php echo e(asset('images/tvseries/posters/'.$poster_link)); ?>" data-downloadable="yes">
     <div data-video-short-description="">
       <div>
         <p class="classicDarkThumbnailTitle"><?php echo e($key+1); ?>. <?php echo e($episode->title); ?></p>
         <p class="minimalDarkThumbnailDesc"><?php echo e($episode->detail); ?></p>
       </div>
     </div>
