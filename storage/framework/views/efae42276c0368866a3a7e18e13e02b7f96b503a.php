        ...
        <div class="row admin-form-block z-depth-1">
          <div class="col-md-6">
            <div class="form-group<?php echo e($errors->has('w_name') ? ' has-error' : ''); ?>">
                ...
                <?php echo Form::text('w_name', null, ['id' => 'pr', 'onkeyup' => 'sync()' ,'class' => 'form-control']); ?>

                <small class="text-danger"><?php echo e($errors->first('w_name')); ?></small>

                <input type="hidden" name="APP_NAME" id="pr2" value="<?php echo e($env_files['APP_NAME']); ?>"/>
            </div>
            ...
            <div class="form-group<?php echo e($errors->has('APP_URL') ? ' has-error' : ''); ?>">
                ...
                <p class="inline info"> - Please enter your app url</p>
