          ...
          <div class="genre-prime-block">
            ...
            <div class="container-fluid">
              ...
              <div class="genre-prime-slider owl-carousel">
               ...
               <?php 
                $getmoviecount = App\FrontSliderUpdate::where('id',2)->first()->movies_show;
                $mc = $getmoviecount+1; 
               ?>
            ...
            ?>
              ...
              <div class="genre-prime-slider owl-carousel">
                <?php if(isset($tvserieses)): ?>
                  ...
                  <?php $__currentLoopData = $tvserieses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=> $series): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
