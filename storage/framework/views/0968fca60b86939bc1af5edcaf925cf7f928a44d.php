      ...
      <div class="card" style="padding: 40px;">
        ...
        <?php if(isset($question) && count($question)>0): ?>
         <?php $__currentLoopData = $question; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ques): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <h5 class="card-title">Fecha : <?php echo e(str_limit($ques->created_at, 10,' ')); ?></h5>
       
        <p class="card-subtitle mb-2 text-muted" style="font-size: 18px; color: #286090">Pregunta: <?php echo e($ques->question); ?>?</p>
        <?php if(isset($ques->answer) && !is_null($ques->answer)): ?>
        <p style="font-size: 16px;">Respuesta: <?php echo e($ques->answer); ?></p><hr>
        <?php else: ?>
