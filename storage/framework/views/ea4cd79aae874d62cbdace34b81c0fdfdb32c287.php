  ...
  <aside class="main-sidebar" style="background-image: url(<?php echo e(asset('images/sidebar-7.jpg')); ?>);">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php if(App\PaypalSubscription::count()>0): ?>
        ...
        <li><a class="<?php echo e(Nav::isResource('question')); ?>" href="<?php echo e(url('/admin/question')); ?>" title="Movies"><i class="material-icons">contact_support</i> <span>Asked Question</span></a></li>
        <li><a class="<?php echo e(Nav::isResource('excersice')); ?>" href="<?php echo e(url('/admin/exercise')); ?>" title="Movies"><i class="material-icons">fitness_center</i> <span>Exercises</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="<?php echo e(Nav::isResource('usergroup')); ?>"><a href="<?php echo e(url('admin/wishlist/usergroup')); ?>" title="Landing Page"><i class="fa fa-circle-o"></i>User Group</a></li>
            <li class="<?php echo e(Nav::isResource('videogroup')); ?>"><a href="<?php echo e(url('admin/wishlist/videogroup')); ?>" title="Landing Page"><i class="fa fa-circle-o"></i>Video Group</a></li>
            <li class="<?php echo e(Nav::isResource('userwishlist')); ?>"><a href="<?php echo e(url('admin/wishlist/userwishlist')); ?>" title="Landing Page"><i class="fa fa-circle-o"></i>User Wishlist</a></li>
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isResource('settings')); ?> <?php echo e(Nav::isRoute('term_con')); ?> <?php echo e(Nav::isRoute('pri_pol')); ?> <?php echo e(Nav::isRoute('copyright')); ?> <?php echo e(Nav::isRoute('mail.getset')); ?>" title="Site Settings">
          ...
          <ul class="treeview-menu">
            ...
            <li class="<?php echo e(Nav::isRoute('mail.getset')); ?>"><a href="<?php echo e(route('mail.getset')); ?>" title="Mail Settings"><i class="fa fa-circle-o"></i> Mail Setting</a></li>
