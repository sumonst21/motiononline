            ...
            <div class="m-t-lg">
              ...
              <div class="social-login">
                <div class="row">
                  ...
                  <div class="col-md-12">
                     <a style="background: linear-gradient(270deg, #48367d 0%, #241842 100%);" href="<?php echo e(url('/auth/gitlab')); ?>" class="btn btn--form btn--form-login" title="Register With Gitlab"><i class="fa fa-gitlab"></i> Register With GitLab</a>
                  </div>
                </div>
              </div>
