<?php $__env->startSection('title','Group User'); ?>
<?php $__env->startSection('content'); ?>
  <div class="content-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="<?php echo e(url('admin/wishlist/usergroup')); ?>" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Users</h4>
    <div class="content-block box-body">
      <table id="movies_table" class="table table-hover">
        ...
        <?php if($old): ?>
          <tbody>
            <?php ($no = 1); ?>
            <?php $__currentLoopData = $old; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <tr>
                <td>
                  <div class="inline">
                  ...
                  <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        <?php echo Form::open(['method' => 'DELETE', 'action' => ['WishListUserGroupController@userdestroy',$id, $group->id]]); ?>
