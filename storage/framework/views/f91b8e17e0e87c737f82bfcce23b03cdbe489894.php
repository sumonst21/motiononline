                  ...
                  <div class="dropdown prime-dropdown">
                    ...
                    <ul class="dropdown-menu prime-dropdown-menu">
                      ...
                      <li>
                        ...
                        <a href="<?php echo e(route('languageSwitch', $language->local)); ?>"><?php echo e($language->name); ?> 
              ...
              <li class="sign-in-block">
                <div class="dropdown prime-dropdown">
                  ...
                  <ul class="dropdown-menu prime-dropdown-menu">
                    ...
                    <?php if($subscribed == 1): ?>
                      <li><a href="<?php echo e(url('account/userwatchlist', $menu->slug)); ?>" class="active"><?php echo e($header_translations->where('key', 'watchlist')->first->value->value); ?></a></li>
                    <?php else: ?>
                    ...
                    <?php if(isset(Auth::user()->paypal_subscriptions)): ?>
