  ...
  <aside class="main-sidebar" style="background-image: url(<?php echo e(asset('images/sidebar-7.jpg')); ?>);">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#" class="<?php echo e(Nav::isResource('ads')); ?> <?php echo e(Nav::isRoute('term_con')); ?>" title="Site Settings">
            <i class="material-icons">settings</i> <span>Advertisements</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
