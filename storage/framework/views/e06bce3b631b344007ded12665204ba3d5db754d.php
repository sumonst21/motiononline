<?php $__currentLoopData = $movies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movie): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <ul id="playlists" style="display:none;">
		...
		<ul id="playlist1" style="display:none;">
				...
				<li data-thumb-source="content/thumbnails/small-fwd.jpg" data-video-source="<?php echo e($movie->trailer_url); ?>" data-subtitle-soruce="[{source:'content/english_subtitle.txt', label:'English'}, {source:'content/romanian_subtitle.txt', label:'Romanian'},{source:'content/spanish_subtitle.txt', label:'Spanish'}]"  data-start-at-subtitle="2" data-downloadable="yes">	<div data-video-short-description="">
						<div>
