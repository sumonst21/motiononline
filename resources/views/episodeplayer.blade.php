...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body style="background-color:#999999; padding:0px; margin:0px;">	
		...
		<ul id="episode">
  		...
  		data-video-source="[<?php if($slink->url_360 !=""){ ?>{source:'{{ $slink->url_360 }}', label:'360p'}, <?php } ?> <?php if($slink->url_480 !=""){ ?>{source:'{{ $slink->url_480 }}', label:'480p'}, <?php } ?> <?php if($slink->url_720 !=""){?>{source:'{{ $slink->url_720 }}', label:'hd720'}, <?php } ?> <?php if($slink->url_1080 !=""){?> {source:'{{ $slink->url_1080 }}', label:'hd1080'}, <?php } ?>]" @endif
