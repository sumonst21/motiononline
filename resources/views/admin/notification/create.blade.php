...
@section('content')
  <div class="admin-form-main-block mrg-t-40">
    <h4 class="admin-form-text"><a href="{{url('admin/notification')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Create Notification</h4>
    <div class="row">
      <div class="col-md-6">
          ...
          {!! Form::open(['method' => 'POST', 'action' => 'NotificationController@store']) !!}
            ...
            <div class="form-group{{ $errors->has('tv_id') ? ' has-error' : '' }}">
                ...
                <select class="form-control select2" name="tv_id">
                  ...
                  <option value="{{$tvs->id}}">{{$tvs->title}}</option>
                @endforeach
                </select>
