...
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('exercise.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Create Exercise</a>
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              {!! Form::open(['method' => 'POST', 'action' => 'ExcersiceController@bulk_delete', 'id' => 'bulk_delete_form']) !!}
              ...
              <tr id="item-{{$menu->id}}">
                ...
                <td>
                  <div class="admin-table-action-block">
                    <a href="{{route('exercise.edit', $menu->id)}}" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
              ...
              <div id="{{$menu->id}}deleteModal" class="delete-modal modal fade" role="dialog">
                <div class="modal-dialog modal-sm">
                  ...
                  <div class="modal-content">
                    ...
                    <div class="modal-footer">
    {!! Form::open(['method' => 'DELETE', 'action' => ['ExcersiceController@destroy', $menu->id]]) !!}
                          <button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
                          <button type="submit" class="btn btn-danger">Yes</button>
                      {!! Form::close() !!}
                    </div>
