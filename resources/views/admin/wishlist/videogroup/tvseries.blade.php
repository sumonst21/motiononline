...
@section('title','Group Tv Series')
@section('content')
  <div class="content-main-block mrg-t-40">
      <h4 class="admin-form-text"><a href="{{url('admin/wishlist/videogroup')}}" data-toggle="tooltip" data-original-title="Go back" class="btn-floating"><i class="material-icons">reply</i></a> Tv Series</h4>
              ...
              <tr>
               ...
               <td><img
                  @if ($group->thumbnail != null)
                    src="{{asset('/images/tvseries/thumbnails/' . $group->thumbnail)}}"
                  @elseif(isset($group->seasons[0]) && $group->seasons[0]->thumbnail != null)
                    src="{{asset('/images/tvseries/thumbnails/' . $group->seasons[0]->thumbnail)}}"  
                  @elseif ($group->poster != null)
                    src="{{asset('/images/tvseries/posters/' . $group->poster)}}"
                  @else
                  ...
                  <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        {!! Form::open(['method' => 'DELETE', 'action' => ['WishListUserVideoController@tvdestroy',$id, $group->id]]) !!}
