...
@section('content')
  <div class="content-main-block mrg-t-40">
    <div class="admin-create-btn-block">
      <a href="{{route('usergroup.create')}}" class="btn btn-danger btn-md"><i class="material-icons left">add</i> Create Group</a>
      <!-- Delete Modal -->
        ...
        <div class="modal-dialog modal-sm">
          ...
          <div class="modal-content">
            ...
            <div class="modal-footer">
              {!! Form::open(['method' => 'POST', 'action' => 'WishListUserGroupController@bulk_delete', 'id' => 'bulk_delete_form']) !!}
              ...
              <tr>
                ...
                <td>
                  <div class="admin-table-action-block"> 
                    <a href="{{url('admin/wishlist/user/detail', $group->id)}}" data-toggle="tooltip" data-original-title="Group Users" class="btn-default btn-floating"><i class="material-icons">desktop_mac</i></a>
                    <a href="{{route('usergroup.edit', $group->id)}}" data-toggle="tooltip" data-original-title="Edit" class="btn-info btn-floating"><i class="material-icons">mode_edit</i></a>
                    <!-- Delete Modal -->
                ...
                <div id="{{$group->id}}deleteModal" class="delete-modal modal fade" role="dialog">
                  <div class="modal-dialog modal-sm">
                    ...
                    <div class="modal-content">
                      ...
                      <div class="modal-footer">
                        {!! Form::open(['method' => 'DELETE', 'action' => ['WishListUserGroupController@destroy', $group->id]]) !!}
                          <button type="reset" class="btn btn-gray translate-y-3" data-dismiss="modal">No</button>
                          <button type="submit" class="btn btn-danger">Yes</button>
                        {!! Form::close() !!}
                      </div>
