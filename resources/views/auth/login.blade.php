        ...
        <div class="container__child signup__form">
          <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
              ...
              <input id="password" type="password" class="form-control" name="password" placeholder="" value="{{ old('password') }}">
            ...
            <div class="m-t-lg">
              ...
              <a class="signup__link pull-left" href="{{ route('password.request') }}">Olvidaste tu contraseña?</a>
              <a class="signup__link pull-right" href="{{url('register')}}">No estas registrado?  Click aqui!</a>
            </div>
          </form>
        </div>
      </div>
